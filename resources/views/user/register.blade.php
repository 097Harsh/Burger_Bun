        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9">
                    <div class="col-lg-12">
                        <h3 class="title-big">Registeration</h3>
                        <p class="mb-4 mt-lg-0 mt-2">Your information  will not be published. All fields are required *</p>
                        <form action="{{ url('/registration_store') }}" method="post" class="text-right" enctype="multipart/form-data">
                        @csrf
                            ...
                            <input type="text" name="contact" id="contact" placeholder="Enter contact" required=""><br><br>
                            ...
                            <button type="submit" name="submit" id="submit" class="btn btn-primary btn-style mt-3">Register</button>
                        </form>
