						...
						<table class="table table-hover"> 
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('order_complete', ['o_id' => $item->order_id]) }}" class="btn btn-success"><i class="fa fa-check" aria-hidden="true"></i></a>
                                        <a href="{{ route('order_cancle', ['o_id' => $item->order_id]) }}" class="btn btn-danger"><i class="fa fa-close"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody> 
