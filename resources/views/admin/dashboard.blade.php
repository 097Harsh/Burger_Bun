...
<!-- //side nav css file -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha384-N7/jyLHHf0zxtTlkMfsb1bHq7HP2wBmNhB4+wi5axJ+osZJbW0Z7cT9uTJXILpfj" crossorigin="anonymous">
 <!-- js-->
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{$totalCompletedPrice}}</strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{$pendingorder}}</strong></h5>
